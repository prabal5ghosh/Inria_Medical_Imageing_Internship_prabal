...
plt.ylabel('Intensity')
plt.grid(True)
plt.savefig('/home/prghosh/prabal_ghosh/Inria_Medical_Imageing_Internship_prabal/s0006/cluster_code/gmm_box_7_cluster.png', dpi=300)  # Save the plot
...
# %%
print(df_mm_cluster_back["cluster_gmm"].unique())

# %%
df_mm_cluster_back['cluster_gmm'] = df_mm_cluster_back['cluster_gmm'].replace(0, 7)    # now we have 7 different clusters 1,2,3,4,5,6,7. here i have replaced 0 with 7.   
print(df_mm_cluster_back["cluster_gmm"].unique())
...
nib.save(cluster_img_gmm, '/home/prghosh/prabal_ghosh/Inria_Medical_Imageing_Internship_prabal/s0006/cluster_code/cluster_7_gmm.nii.gz')
